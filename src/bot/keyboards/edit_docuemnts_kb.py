...
def kb_edit_document(doc_id: int) -> InlineKeyboardMarkup:
    keyboard_list = [
        [InlineKeyboardButton(text='Изменить название', callback_data=f'edit_doc_title:{doc_id}')],
        [InlineKeyboardButton(text='Исправить ошибку в расшифровке', callback_data=f'edit_doc_text:{doc_id}')],
